class Quiz {
 ...
 start(){
  ...
  play(){
    ...
    if( allContestants.data !== undefined){
      debugger;
      var display_Answers = 230;
      fill("Blue");
      textSize(20);
      //add a Note to help contestants understand the result.
      text("NOTE: Contestants who have answered correctly have their names highlighted in green. And whose names are highlighted in red are, unfortunately, wrong",130,230);
